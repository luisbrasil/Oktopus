...
class CampoUrlAvatar extends StatelessWidget {
  final qtdeMinimaCaracteres = 1;
  final TextEditingController controle;
  const CampoUrlAvatar({required this.controle, Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: const InputDecoration(
          label: Text('UrlAvatar:'), hintText: 'Informe o url do avatar:'),
    );
  }
